...
#ifdef NDEBUG
#define TFLITE_DCHECK_EQ(x, y) ((void)0)
#else
...
#ifdef NDEBUG
#define TFLITE_DCHECK_NE(x, y) ((void)0)
#else
...
#ifdef NDEBUG
#define TFLITE_DCHECK_GE(x, y) ((void)0)
#else
...
#ifdef NDEBUG
#define TFLITE_DCHECK_GT(x, y) ((void)0)
#else
...
#ifdef NDEBUG
#define TFLITE_DCHECK_LE(x, y) ((void)0)
#else
...
#ifdef NDEBUG
#define TFLITE_DCHECK_LT(x, y) ((void)0)
#else
